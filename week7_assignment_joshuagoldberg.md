...
```
    ...
    ## mu[1]      99.24    0.02 1.77   95.60   98.06   99.24  100.44  102.64
    ## mu[2]     107.08    0.04 2.74  101.81  105.24  107.08  108.87  112.63
    ## sigma[1]   11.38    0.03 1.72    8.40   10.17   11.22   12.43   15.07
    ## sigma[2]   18.00    0.04 2.79   12.97   16.05   17.77   19.79   23.76
    ## nu          3.91    0.03 1.65    1.96    2.84    3.54    4.52    8.16
    ## lp__     -451.03    0.04 1.61 -454.85 -451.90 -450.68 -449.84 -448.88
    ##          n_eff Rhat
    ## mu[1]     5371    1
    ## mu[2]     4932    1
    ## sigma[1]  4386    1
    ...
    ## lp__      2061    1
    ## 
    ## Samples were drawn using NUTS(diag_e) at Thu Dec  6 02:38:10 2018.
...
```
    ...
    ## -3.6560  -0.0099   0.0000   0.0034   3.5450  
    ## 
    ## Coefficients:
    ##               Estimate Std. Error z value Pr(>|z|)    
    ## (Intercept) -193.76808    9.78854  -19.80   <2e-16 ***
    ## Mu             1.70289    0.08876   19.19   <2e-16 ***
    ## Sigma          1.31949    0.07295   18.09   <2e-16 ***
    ## ---
    ...
    ## Residual deviance:   535.39  on 9997  degrees of freedom
    ## AIC: 541.39
    ## 
...
```
    ...
    ## 
    ## Samples were drawn using NUTS(diag_e) at Thu Dec  6 02:40:02 2018.
    ## For each parameter, n_eff is a crude measure of effective sample size,
    ## and Rhat is the potential scale reduction factor on split chains (at 
    ## convergence, Rhat=1).
...
```
    ...
    ## 
    ## Samples were drawn using NUTS(diag_e) at Thu Dec  6 02:40:50 2018.
    ## For each parameter, n_eff is a crude measure of effective sample size,
    ## and Rhat is the potential scale reduction factor on split chains (at 
    ## convergence, Rhat=1).
...
```
    ...
    ## 
    ## Samples were drawn using NUTS(diag_e) at Thu Dec  6 02:41:47 2018.
    ## For each parameter, n_eff is a crude measure of effective sample size,
    ## and Rhat is the potential scale reduction factor on split chains (at 
    ## convergence, Rhat=1).
