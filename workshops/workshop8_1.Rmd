...
* Strong correlation between beta0 and beta1, and beta0 and beta2
...
Small sigma forces slopes to shrink towards zero mean. At the same time small ?? (maybe: $\nu$)  makes the tails fat enough to allow some strong slopes to be outliers.

Parameter sigma of the prior for regression coefficients beta can be either fixed, or given its own prior and estimated.
