...
* Uses pair-wise odds ratio; but when we fit we fit one model

* if pairs plot indicares strong correlation, we may be more cautious about removing insigificant variables
